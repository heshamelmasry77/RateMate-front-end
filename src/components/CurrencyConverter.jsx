    ...
    <div className="currency-converter min-w-96 rounded-lg bg-white p-6 shadow-md">
      ...
      >
        ...
        <div className="relative w-full">
          ...
          <div className="mt-2">
            <input
              ...
              required
              className="block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600 sm:text-sm"
            />
          </div>
        </div>
        <div className="relative w-full">
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-4 w-full rounded-md bg-emerald-600 px-4 py-2 text-lg font-semibold text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600"
        >
